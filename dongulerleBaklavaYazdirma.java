...
public class dongulerleBaklavaYazdirma {
    public static void main(String[] args) {
        ...
        {
            for (k=n;k>i;k--)//bu for döngümüz ekran çıktısının sol tarafındaki boşlukları yazdırıyor.
            {
                System.out.print(" ");
            }
            for (j = 1; j <=i ; j++)//bu for döngümüzde ise yıldız şeklimizi çıkartıyor ve yıldızların arasındaki boşluğu yazdırıyor.
            {
                System.out.print("*"+" ");
            }
            System.out.println();
